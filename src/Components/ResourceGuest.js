    ...
    return (
        <div>
            ...
            <div className="container"><br/>
                ...
                {!props.isLoggedIn ?
                    (
                        <p>Please <Link to="/loginGuest"> log in </Link> to send an alert to Care Team members.</p>
                    ):
                    (
                        <div>
                ...
                {!props.isLoggedIn ?
                    (
                        <p>Please <Link to="/loginGuest"> log in </Link> to view or manage Care Team members.</p>
                    ):
                    (
                        <ManageCareTeam />
                    )
...
export default connect(mapStateToProps)(ResourceGuest);