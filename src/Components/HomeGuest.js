...
<div>
    ...
    <div class="col-lg-8 mx-auto p-3 py-md-5">
      ...
      <div className="mb-5">
        <button className="btn btn-success btn-lg px-4"><Link to="/aboutGuest">Learn More</Link></button>
      </div>
      ...
      <div className="row g-5">
        <div className="col-md-6">
          ...
          <div className="mb-5">
            <button className="btn btn-success btn-lg px-4"><Link to="/resourceGuest">Resources</Link></button>
          </div>
        </div>
        ...
        <div className="col-md-6">
          ...
          <ul className="icon-list">
            <li><Link to="/resourceGuest">Alternate Alert Response</Link></li>
            <li><Link to="/resourceGuest">General Resources</Link></li>
            <li><Link to="/resourceGuest">Care Teams</Link></li>
          </ul>
        </div>
      </div>
    </main>
