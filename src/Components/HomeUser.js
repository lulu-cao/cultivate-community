...
<main>
  ...
  <br/>
    ...
    <div className="mb-5">
      <a href="./about-user.html" className="btn btn-success btn-lg px-4">Learn More</a>
    </div>
    ...
    <div className="row g-5">
      <div className="col-md-6">
        ...
        */}
        ...
        <div className="mb-5">
          <a href="./resource-user.html" className="btn btn-success btn-lg px-4">Resources</a>
        </div>
      </div>
      ...
      <div className="col-md-6">
        ...
        <ul className="icon-list">
          <li><a href="./resource-user.html">Alternate Alert Response</a></li>
          <li><a href="./resource-user.html">General Resources</a></li>
          <li><a href="./resource-user.html">Care Teams</a></li>
        </ul>
      </div>
    </div>
</main>
