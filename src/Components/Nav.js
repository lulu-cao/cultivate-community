  ...
  <div>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="container-fluid">
        <a class="navbar-brand" href="#"><img src="./_images/logo.png" alt="Cultivate Community"/></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <button class="btn btn-outline-success" type="submit"><a href="loginpage.html" style="color:black; text-decoration: none;">Log Out</a></button>
        </div>
      </div>
    </nav>
  </div>
